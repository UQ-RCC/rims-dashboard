...
import rimsdash.auth

#--------------
#SETUP
#--------------

VALID_USERNAME_PASSWORD_PAIRS = rimsdash.auth.get_auth_details()
...
def create_dashboard(server):
    ...
    init_callbacks(dash_app, user_dropdown, project_table)

    return dash_app.server

def init_callbacks(dash_app, user_dropdown, project_table):
